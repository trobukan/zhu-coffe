window.masterCSSConfig = {
  ...
  components: {
    ...
    "accordion-header": "flex jc:space-between w:100% p:0px p:0.5rem|1rem fg:white r:0.5rem@<sm",
    "accordion-content": "overflow:hidden h:auto transition:all 0.3s ease flex-col@<sm jc:start ai:start@<sm",
    "accordion-collapsed": "h:0 hidden@<sm",
    "accordion-icon": "w:24px transition:all 0.3s display:none@>=sm"
  }
}